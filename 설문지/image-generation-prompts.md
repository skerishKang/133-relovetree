...
- 영상 썸네일은 추상적 블러 이미지 또는 일러스트형 placeholder로 표현
- 컬러 방향은 warm cream, soft rose, muted green, muted slate
- 분위기는 감정적 팬 다이어리, 영상 아카이브, 부드러운 러브트리
- n8n, Figma, 개발자용 플로우차트처럼 보이지 않게 하기
...
- Hero title in Korean: “사랑에 빠진 모든 순간을 기록해 보세요”
- Subtitle: “영상, 날짜, 감정, 메모가 이어져 나만의 러브트리가 됩니다”
- Primary CTA button: “첫 러브트리 만들기”
- Secondary CTA button: “다른 러브트리 구경하기”
- Show a preview of a connected LoveTree with 4 to 6 video memory cards
- Include small sections for “기록하기”, “연결하기”, “다시 보기”, “공유하기”
- No real idol photos, no real brand logos, no copyrighted content
...
- Title in Korean: “다른 팬들의 러브트리 구경하기”
- Cards showing shared LoveTrees
- Each card includes abstract thumbnail collage, title, author display name, emotion tags, like count, comment count
- Include filters: “인기”, “최신”, “입덕”, “콘서트”, “직캠”, “컴백”
- Include a featured LoveTree card that previews a connected mini tree
...
- Korean title: “나의 러브트리”
- Primary button: “새 러브트리 만들기”
- List/grid of user's LoveTrees
- Each tree card shows title, last updated date, public/private badge, number of moments, thumbnail preview
- Include a small “최근 수정한 순간” area
...
Screen:
- Mobile-first design
- Korean headline: “내 러브트리를 계속 이어가려면 로그인하세요”
- Subtext: “기록한 순간을 안전하게 저장하고, 다른 기기에서도 이어서 볼 수 있어요”
- Login options: Google login, email login
- Soft profile preview card with display name: “테스트 러버 A”
- Show benefits: “기록 저장”, “공유 관리”, “댓글 알림”, “내 트리 동기화”
...
- Korean title: “첫 콘서트의 전율”
- Date: “2023.11.15”
- Emotion tags: “설렘”, “감동”, “행복”
- Memo section with handwritten diary-like feeling
- Section: “이 순간과 이어진 기억”
- Show 2 small connected memory cards below
...
- Title: “어느 순간과 연결할까요?”
- Show a simplified vertical LoveTree with 3 existing memory cards
...
- Bottom action button: “이 순간 뒤에 연결하기”
- The UI should feel simple enough for mobile, not a complex desktop canvas
...
Screen:
- Mobile app UI
- Search bar with Korean placeholder: “무대, 직캠, 영상 링크 검색”
- Results list with abstract video thumbnails, titles, dates, channel-like text
- Each result has a button: “러브트리에 추가”
- Include a selected result preview at the bottom
- Show tags: “무대”, “직캠”, “컴백”, “콘서트”
- No real YouTube logo, no real idol photos, no copyrighted content
...
- Korean headline: “아직 러브트리가 없어요”
- Subtext: “처음 좋아하게 된 순간부터 하나씩 이어보세요”
- Soft illustration of a small sprout growing into video memory cards
- Primary button: “첫 순간 기록하기”
- Secondary link: “예시 러브트리 보기”
- Include 3 tiny example chips: “입덕”, “첫 콘서트”, “최애 무대”
- Warm cream background, rose and muted green accents
...
- Top toolbar with title input: “새 러브트리”
- Empty canvas with a soft central starting point
- Korean prompt in the canvas: “첫 순간을 추가해 러브트리를 시작하세요”
- Button in canvas: “첫 순간 추가”
- Show faint branch guides in the background
...
- Header: “테스트 러버 A의 러브트리”
- Subtitle: “입덕부터 지금까지 이어진 순간들”
- Main area shows connected memory cards in a tree flow
...
Screen:
- Mobile settings UI
- Korean title: “공개 범위 설정”
- Options:
  - “나만 보기”
  - “링크를 가진 사람만”
  - “커뮤니티에 공개”
- Include toggles for comments, likes, profile display name
