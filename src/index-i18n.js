(function () {
    const translations = {
        ko: {
            title: "사랑에 빠진 모든 순간을<br> 기록해 보세요",
            subtitle: "나의 러브트리로 좋아하는 아티스트의 모든 순간을<br> 한 곳에 차곡차곡 모아 보세요.",
            create: "새로운 트리 만들기",
        ...
        en: {
            title: "Capture every moment<br> you fall in love.",
            subtitle: "Gather all your stan moments<br> into a single LoveTree.",
    ...
    function updateUIText() {
        ...
        Object.keys(elementsToUpdate).forEach(function (id) {
            ...
            if (el) {
                if (id === 'page-title' || id === 'page-subtitle') {
